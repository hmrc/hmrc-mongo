...
import uk.gov.hmrc.crypto.{Crypted, Protected, SymmetricCryptoFactory}
...
object ProtectedEncryptionSpec {
  ...
  object MyObject {
    ...
    private implicit val psf = JsonEncryption.protectedEncrypterDecrypter[String]
    private implicit val pbf = JsonEncryption.protectedEncrypterDecrypter[Boolean]
    private implicit val plf = JsonEncryption.protectedEncrypterDecrypter[Long]
    private implicit val pnf = JsonEncryption.protectedEncrypterDecrypter[Nested]
